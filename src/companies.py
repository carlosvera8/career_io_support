...
COMPANIES = [
    ...
    # ── FROM companies_merged.csv ───────────────────────────────────────────────
    # Greenhouse
    {"name": "Etsy", "greenhouse_slug": "etsy", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.3, "employee_count_estimate": 2400, "notes": "Marketplace; remote-friendly"},
    {"name": "Upwork", "greenhouse_slug": "upwork", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 800, "notes": "Marketplace; remote-friendly"},
    {"name": "Khan Academy", "greenhouse_slug": "khanacademy", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.3, "employee_count_estimate": 270, "notes": "Nonprofit EdTech; mission-driven; flexible"},
    {"name": "Teradata", "greenhouse_slug": "teradata", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 6500, "notes": "Remote-friendly; mature data warehouse"},
    {"name": "Arm", "greenhouse_slug": "arm", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 7500, "notes": "Chips/AI; hybrid"},
    {"name": "LogicGate", "greenhouse_slug": "logicgate", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 250, "notes": "GRC SaaS; remote-friendly"},
    {"name": "Workiva", "greenhouse_slug": "workiva", "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 2700, "notes": "SaaS for financial reporting; SWE WLB=4.8"},
    # Lever
    {"name": "Deel", "greenhouse_slug": None, "lever_slug": "deel", "ashby_slug": None, "glassdoor_wlb_score": 4.3, "employee_count_estimate": 6000, "notes": "Fully remote; global; fast pace"},
    {"name": "Rec Room", "greenhouse_slug": None, "lever_slug": "recroom", "ashby_slug": None, "glassdoor_wlb_score": 4.6, "employee_count_estimate": 300, "notes": "VR social gaming; very high WLB"},
    {"name": "Census", "greenhouse_slug": None, "lever_slug": "getcensus", "ashby_slug": None, "glassdoor_wlb_score": 4.5, "employee_count_estimate": 100, "notes": "Reverse ETL; small but high WLB"},
    {"name": "Appcues", "greenhouse_slug": None, "lever_slug": "appcues", "ashby_slug": None, "glassdoor_wlb_score": 4.7, "employee_count_estimate": 100, "notes": "Product adoption SaaS; remote-first; very high WLB"},
    # Aggregator-only (no ATS slug)
    {"name": "Cisco", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 85000, "notes": "Fortune 500"},
    {"name": "Experian", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": None, "notes": ""},
    {"name": "Doist", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 100, "notes": "Fully async remote; 4-day work week culture"},
    {"name": "SAP", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.3, "employee_count_estimate": 108000, "notes": "Hybrid; large established mature DS function"},
    {"name": "VMware (Broadcom)", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 30000, "notes": "Now Broadcom subsidiary; culture in flux"},
    {"name": "Vanguard", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 20000, "notes": "Hybrid; traditional finance culture"},
    {"name": "Oracle Health (Cerner)", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 25000, "notes": "Cerner now part of Oracle; mostly hybrid"},
    {"name": "Autodesk", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 14000, "notes": "Hybrid; 6-week sabbatical every 4 years"},
    {"name": "Wix", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 5500, "notes": "Israel HQ; remote-friendly"},
    {"name": "Squarespace", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 1500, "notes": "NY-centered; SWE WLB=4.4"},
    {"name": "Fiverr", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 1100, "notes": "Marketplace; remote-friendly"},
    {"name": "SAS", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 12000, "notes": "Private; very strong WLB reputation; 35-hr week"},
    {"name": "MITRE", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 9000, "notes": "Nonprofit research/defense; flexible"},
    {"name": "RAND", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 2000, "notes": "Nonprofit research; analyst WLB lower (3.2)"},
    {"name": "Federal Reserve Banks", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 23000, "notes": "Aggregate of regional Reserve Banks (NY/Board avg)"},
    {"name": "Bloomberg", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 22000, "notes": "FinTech/Media; NY office-heavy"},
    {"name": "Accenture Federal", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 20000, "notes": "Accenture Federal Services LLC; US-government-only subsidiary; security clearance often required; separate Glassdoor page from parent Accenture"},
    {"name": "Deltek", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.7, "employee_count_estimate": 3000, "notes": "Top 10 in Glassdoor 2024 Employees Choice; project-based ERP"},
    {"name": "UserGems", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 5.0, "employee_count_estimate": 100, "notes": "Small SaaS; very high WLB"},
    {"name": "McGraw Hill", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 5000, "notes": "EdTech publisher; mature; remote-friendly"},
    {"name": "Beekeeper", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 250, "notes": "Frontline workforce app; Zurich HQ"},
    {"name": "Intrado", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 9000, "notes": "Comm tech; private equity-owned"},
    {"name": "Funded.club", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.4, "employee_count_estimate": 50, "notes": "Fixed-fee startup recruiting agency; remote"},
    {"name": "Workera", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 100, "notes": "AI skills assessment; remote"},
    {"name": "Uplers", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.0, "employee_count_estimate": 1000, "notes": "India-based tech talent agency"},
    {"name": "Buffer", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 90, "notes": "Social media tools; fully remote; 4-day work week"},
    {"name": "Constructor", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.5, "employee_count_estimate": 250, "notes": "AI ecommerce search; remote"},
    {"name": "DuckDuckGo", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.8, "employee_count_estimate": 250, "notes": "Search/privacy; fully remote; very high WLB"},
    {"name": "Akamai Technologies", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.5, "employee_count_estimate": 10500, "notes": "CDN/security; mature; remote-friendly"},
    {"name": "Cloudbeds", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.3, "employee_count_estimate": 700, "notes": "Hospitality SaaS; remote-friendly"},
    {"name": "Mentorsity", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.2, "employee_count_estimate": 50, "notes": "Small India-based mentorship platform; remote-friendly"},
    {"name": "iVisa", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.5, "employee_count_estimate": 200, "notes": "Travel/visa SaaS; uses Breezy ATS; remote"},
    {"name": "Symetra", "greenhouse_slug": None, "lever_slug": None, "ashby_slug": None, "glassdoor_wlb_score": 4.1, "employee_count_estimate": 2000, "notes": "Insurance/retirement; remote-first"},
]
